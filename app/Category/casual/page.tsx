...
export const metadata: Metadata = {
  title: 'Restau — Entrées',
  description: "Découvrez notre sélection d'entrées.",
};
...
export default async function CategoryPage() {
  ...
  try {
    articles = await getArticlesByCategory('Entrées'); // ← change per category
  } catch (err) {
