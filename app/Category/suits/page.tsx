...
export const metadata: Metadata = {
  title: 'Restau — Boissons',
  description: "Découvrez notre sélection de boisson.",
};
...
export default async function CategoryPage() {
  ...
  try {
    articles = await getArticlesByCategory('Boissons'); // ← change per category
  } catch (err) {
