...
const TESTIMONIALS = [
  {
    ...
    text: "Grâce à Démo LeadFlow, j'ai trouvé ma villa idéale en quelques semaines. Service exceptionnel, équipe à l'écoute.",
    avatar: 'YB',
  },
  {
    name: 'Salma El Idrissi',
    role: 'Directrice financière, Rabat',
    text: "Professionnalisme et réactivité au rendez-vous. Mon appartement à Agdal correspond parfaitement à ce que je cherchais. Merci !",
    avatar: 'SE',
  },
  {
    name: 'Omar Alaoui',
      ...
      <header className="sticky top-0 z-40 bg-white/95 backdrop-blur border-b border-slate-100">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              href="/dashboard"
              className="hidden md:flex items-center gap-1.5 text-xs font-semibold text-slate-400 hover:text-slate-700 px-3 py-2 rounded-lg hover:bg-slate-100 transition-colors"
            >
      ...
      >
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
          <div className="mb-4 inline-flex items-center gap-2 bg-white/10 backdrop-blur text-white text-xs font-medium px-4 py-2 rounded-full border border-white/20">
            ...
            Agence immobilière • 15 ans d&apos;expertise au Maroc
          </div>
          ...
          <p className="text-lg text-white/85 mb-8 max-w-xl leading-relaxed">
            Villas premium, appartements de standing et opportunités
            d&apos;investissement à Casablanca, Marrakech, Rabat et Tanger.
          </p>
      ...
      <section id="biens" className="py-20 px-6 max-w-6xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-slate-500 mt-3 max-w-xl mx-auto">
            ...
            soigneusement choisies pour leur emplacement et leur qualité.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {properties.map((p) => (
            <div
              key={p.id}
              className="group rounded-2xl overflow-hidden shadow-sm border border-slate-100 hover:shadow-xl transition-shadow duration-300 bg-white"
            >
              <div className="relative overflow-hidden" style={{ height: 224 }}>
                ...
                <span
                  className={`absolute top-3 left-3 text-xs font-bold text-white px-3 py-1 rounded-full ${p.badgeColor}`}
                >
                  {p.badge}
                </span>
        ...
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center gap-12">
          <div className="flex-1">
            ...
            <p className="text-slate-600 leading-relaxed mb-4">
              Démo LeadFlow est une agence de référence dans l&apos;immobilier
              de prestige au Maroc. Présente depuis 2009, notre équipe
              accompagne investisseurs et particuliers dans leurs projets les
              plus ambitieux.
            </p>

            <p className="text-slate-600 leading-relaxed mb-8">
              Notre équipe de consultants expérimentés vous guide à chaque
              étape : de la recherche jusqu&apos;à la signature, avec un
            ...
            <div className="flex flex-wrap gap-3">
              {[
                ...
                <span
                  key={tag}
                  className="text-xs font-medium px-3 py-1.5 rounded-full bg-amber-50 text-amber-700 border border-amber-200"
                >
                  ✓ {tag}
                </span>
              ))}
            ...
            {[
              {
                icon: '🏠',
                title: 'Résidentiel',
                desc: 'Villas, appartements, penthouses',
              },
              {
                icon: '🏢',
                title: 'Commercial',
                desc: 'Bureaux, locaux, entrepôts',
              },
              {
                icon: '📈',
                title: 'Investissement',
                desc: 'Rentabilité et valorisation',
              },
              {
                icon: '🌍',
                title: 'International',
                desc: 'Clients internationaux bienvenus',
              },
            ].map((s) => (
              <div
                key={s.title}
              ...
              >
                ...
                <h4 className="font-semibold text-slate-900 mt-2 text-sm">
                  {s.title}
                </h4>
      ...
      >
        <div className="max-w-3xl mx-auto text-center text-white">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Qualifiez votre projet en 2 minutes
          </h2>

          <p className="text-white/70 mb-8 max-w-lg mx-auto">
            Notre assistant IA vous pose quelques questions et met votre profil
            en relation avec le bon consultant immédiatement.
          </p>
          ...
          <p className="mt-8 text-white/50 text-sm">
            👉 Cliquez sur le bouton chat en bas à droite pour commencer
          </p>
        </div>
      </section>
      ...
      <footer className="bg-slate-950 text-slate-400 py-12 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between gap-8 mb-8">
            <div>
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="font-bold text-white text-lg">
                  Démo <span className="text-amber-500">LeadFlow</span>
                </span>
              </div>

              <p className="text-sm max-w-xs leading-relaxed">
                L&apos;agence de référence pour l&apos;immobilier de prestige
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-8 text-sm">
              <div>
                ...
                <Link
                  href="/"
                  className="block mb-2 hover:text-amber-400 transition-colors"
                >
                  Accueil
                </Link>
                ...
                <Link
                  href="/dashboard"
                  className="block hover:text-amber-400 transition-colors text-slate-500"
                >
                  Dashboard agent
                </Link>
              </div>
              ...
              <div>
                ...
                {['Casablanca', 'Marrakech', 'Rabat', 'Tanger'].map((l) => (
                  <p
                    key={l}
                    className="mb-2 hover:text-amber-400 cursor-pointer transition-colors"
                  >
                    {l}
                  </p>
                ))}
              ...
              <div>
                ...
                <p className="mb-2">📞 +212 522 00 00 00</p>
                <p className="mb-2">✉ contact@leadflowimmo.ma</p>
          ...
          <div className="border-t border-slate-800 pt-6 text-xs text-center text-slate-600">
            © 2026 Démo LeadFlow. Tous droits réservés. • Propulsé par{' '}
            <span className="text-amber-500 font-semibold">Leadflow AI</span>
          </div>
        </div>
      </footer>
